...
void AnimSpriteComponent::Update(float deltaTime)
{
	...
	auto& textures = anim.m_animTextures;
	if (textures.size() > 0) {
...
void AnimSpriteComponent::SetAnimTextures(const std::string& key, const AnimInfo& animInfo)
{
	m_animMap[key] = animInfo;

	auto& animtex = m_animMap[key].m_animTextures;
